...
import com.java5200.properties.WeixinpayProperties;
import com.java5200.service.OrderService;
import com.java5200.util.DateUtil;
import com.java5200.util.DeviceUtil;
import com.java5200.util.HttpClientUtil;
import com.java5200.util.MD5Util;
import com.java5200.util.StringUtil;
import com.java5200.util.XmlUtil;
...
public class WeixinpayController {
	...
	public ModelAndView pay(Order order, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if (DeviceUtil.isMobileDevice(userAgent)) { // 移动设备
			...
			InputStream in = HttpClientUtil.sendXMLDataByPost(weixinpayProperties.getUrl().toString(), xml).getEntity()
					.getContent(); // 发送xml消息
			...
			mav.addObject("title", "微信扫码在线支付_Java项目分享网");
